...
class RepositoryServiceProvider extends ServiceProvider
{
    public function register()
    {
        $bindings = [
            ...
            Settings\Repositories\DepartmentRepository::class => [Settings\Repositories\Interfaces\DepartmentRepositoryInterface::class],
            Settings\Repositories\JobTitleRepository::class => [Settings\Repositories\Interfaces\JobTitleRepositoryInterface::class],
            ...
            Pim\Repositories\PayrollRecordRepository::class => [Pim\Repositories\Interfaces\PayrollRecordRepositoryInterface::class],
            Pim\Repositories\PayslipRepository::class => [Pim\Repositories\Interfaces\PayslipRepositoryInterface::class],
            ...
            Recruitment\Repositories\JobOpeningRepository::class => [Recruitment\Repositories\Interfaces\JobOpeningRepositoryInterface::class],
            Recruitment\Repositories\CandidateApplicationRepository::class => [Recruitment\Repositories\Interfaces\CandidateApplicationRepositoryInterface::class],
            Recruitment\Repositories\InterviewRepository::class => [Recruitment\Repositories\Interfaces\InterviewRepositoryInterface::class],
