{{-- Modern HRM Sidebar Navigation v2 — Admin/HR --}}
<?php
    ...
    // Make $current safe
    $current = $current ?? '';
    // Determine active sidebar items by current request
    $isAttendancePage = Request::is('admin/attendance') || Request::is('admin/attendance/*');
    $isAssetsPage     = Request::is('admin/assets*');
    $isAttendRules    = Request::is('admin/attendance-rules*');
    $isHrAssistant    = Request::is('admin/hr-assistant*');
?>
...
<aside class="hrm-sidebar" id="hrmSidebar">
    ...
    <ul class="sidebar-nav" style="padding-top: 8px;">
        ...
        <li class="{{ $current == 'home' || $current == 'dashboard' ? 'active' : '' }}">
            <a href="{{ route('home') }}">
        ...
        <li class="{{ ($isAttendancePage && !$isAttendRules) ? 'active' : '' }}">
        ...
        <li class="{{ $isAttendRules ? 'active' : '' }}">
            <a href="{{ route('attendance_rules.index') }}">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <li class="{{ $current == 'hr_policies' ? 'active' : '' }}">
            <a href="{{ route('hr_policies.index') }}">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <li>
            <a href="{{ route('attendance.scanner') }}">
                <svg class="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                    ...
                    <line x1="16" y1="16" x2="16" y2="16"/><line x1="12" y1="3" x2="12" y2="9"/>
                    <line x1="12" y1="16" x2="12" y2="21"/><line x1="9" y1="12" x2="3" y2="12"/>
                </svg>
                Scanner Kiosk
            </a>
        </li>
