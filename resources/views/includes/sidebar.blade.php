...
<aside class="hrm-sidebar" id="hrmSidebar">
    ...
    <ul class="sidebar-nav" style="padding-top: 12px;">
        ...
        <li class="{{ (Request::is('admin/attendance') || Request::is('admin/attendance/*')) && !Request::is('admin/attendance-rules*') ? 'active' : '' }}">
        ...
        <li class="{{ Request::is('admin/attendance-rules*') ? 'active' : '' }}">
